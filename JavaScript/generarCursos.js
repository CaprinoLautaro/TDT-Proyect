document.addEventListener("DOMContentLoaded", function () {
    const cursos = [
...

        {
            ...
            valor: 5000,
            descripcion: "Curso de Introducción a Excel: aprende los fundamentos de programación con Excel. Ideal para principiantes, cubrirá variables, estructuras de control, funciones y manejo de datos.",
...

        {
            ...
            valor: 3499.99,
            descripcion: "Curso de Introducción a HTML: aprende los fundamentos de programación con HTML. Ideal para principiantes, cubrirá variables, estructuras de control, funciones y manejo de datos.",
...

        {
            ...
            valor: 3499.99,
            descripcion: "Curso de Introducción a JAVA: aprende los fundamentos de programación con JAVA. Ideal para principiantes, cubrirá variables, estructuras de control, funciones y manejo de datos.",
